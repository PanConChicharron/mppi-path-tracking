...
int main(int argc, char** argv)
{
  ...
  const std::string video_path = "first_order_dubins_intersection_left_turn.mp4";
  ...
  mppi::viz::drawStraightCorridor(base_frame, -120.0F, -2.5F, 55.0F, -2.5F, kCrossStreetHalfWidth * 0.9F);
  mppi::viz::drawStraightCorridor(base_frame, -120.0F, -3.8F, 55.0F, -3.8F, kCrossStreetHalfWidth);
  mppi::viz::drawStraightCorridor(base_frame, -120.0F, -5.0F, 55.0F, -5.0F, kCrossStreetHalfWidth * 0.92F);
  mppi::viz::drawStraightCorridor(base_frame, -120.0F, -6.2F, 55.0F, -6.2F, kCrossStreetHalfWidth * 0.85F);
  ...
  cv::namedWindow("MPPI Intersection", cv::WINDOW_NORMAL);
  ...
  for (int k = 0; k < num_sim_steps; ++k)
  {
    ...
    mppi::viz::drawParkedCars(frame, cross_viz, cv::Scalar(40, 80, 200), cv::Scalar(20, 40, 120));
    ...
    mppi::viz::showCompositeFrame("MPPI Intersection", composite, plot_layout);
    step_timing.endViz();
